# Motivic Realizations — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/motivic-realizations-canonical-lane-mathlib.git
cd motivic-realizations-canonical-lane-mathlib
lake exe
lake build
```
