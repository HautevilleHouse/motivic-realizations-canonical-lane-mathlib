/-!
# motivic-realizations-canonical-lane Lean migration boundary
...
`MotivicRealizationsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "motivic-realizations-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/motivic-realizations-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Motivic Realizations: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["manifold-constrained", "canonical-lane", "local-to-global", "motives", "arithmetic-geometry", "regulators", "filtrations", "mathematical-proof", "reproducibility"]
